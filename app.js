...
app.post("/register/", async (request, response) => {
  ...
  console.log(password.length); // check if user already exists with the same username
...
// names of people whome user follows api
